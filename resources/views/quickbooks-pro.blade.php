    ...
    <div class="w-full py-2 ">
        ...
        <div class="w-full flex flex-col items-center gap-4 justify-center py-4 text-center">
            <h1 class="text-black font-semibold lg:text-[30px] md:text-[30px] text-[25px]">
                Unlock Efficiency and Collaboration with QuickBooks Pro Hosting Services
            </h1>
        ...
        <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
            <div class="w-full h-max p-4 relative">
                ...
                <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                    <img class=" w-full h-full object-cover" src="{{asset('assets/images/quickbooks-hosting/bookpro.jpg')}}" alt="">
                </div>
            ...
            <div class="w-full h-full flex">
                <div class=" text-justify p-4">
                    ...
                    <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                        Winscloud is a leading IT company that offers the best QuickBooks hosting services to CPAs, accountants and record keepers and small and medium businesses in the UK, US, and Canada. Our prime aim is to provide an operational, reliable, updateable, compatible and efficient platform for QuickBooks desktop version. Our systems are highly secure and give you user-friendly control to save your time and efforts.
                    </p>

                    <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                        We host almost every edition of QuickBooks platform including US and Canada versions. The previous versions of QuickBooks such as those were launched in 2005, QB pro-2014, 2015, 2019 and the latest 2022, all are compatible with our advanced cloud server setups and makes use better than the others. We have hundreds of add-on in our QuickBooks server hosting plans to cater their financial operations with extreme ease and accuracy and save a lot of time and money to buy other resources.
                    </p>
        ...
        <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
            ...
            <div class="w-full h-max p-4 relative">
                ...
                <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                    <img class=" w-full h-full object-cover" src="{{asset('assets/images/quickbooks-hosting/qb-pro.jpg')}}" alt="">
                </div>
                <img class="rotatingImg w-auto lg:h-[600px] md:h-[600px] h-[500px] mx-auto" src="{{asset('assets/images/home/circle.png')}}" alt="">
            </div>
