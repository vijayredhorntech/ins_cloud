            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                ...
                <div class="w-full h-full flex flex-col items-center py-12">
                    ...
                    <div class="w-full flex justify-center py-2">
                        <span class="text-black font-semibold text-[25px]">Log In to Your Account</span>
                    </div>
                    <div class="w-full flex py-2">
                        <span class="text-gray-500 font-normal text-[15px]">New User?<a href="{{route('registration')}}"> Sign Up</a> </span>
                    </div>

                    <div class="w-full flex flex-col gap-2">
                        <div class="grid  grid-cols-1 gap-6">
                            <input type="email" placeholder="Email" class="p-3 w-full">
                            <input type="password" placeholder="Password" class="p-3 w-full">
