...
@section('content')
        ...
        <div class="lg:w-[70%] md:w-[90%] w-full h-full mx-auto">
            <div class="w-full flex flex-col items-center gap-4 justify-center py-4 text-center">
                <h1 class="text-black font-semibold lg:text-[30px] md:text-[30px] text-[25px]">
                    ProSeries Hosting for flawless Taxation
                </h1>
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/services/proserise-hosting.jpg')}}" alt="">
                    </div>
                ...
                <div class="w-full h-full flex">
                    <div class=" text-justify p-4">
                        ...
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            ProSeries hosting is one-stop solutions for CPAs which empowers them with a smart and efficient taxation tool that allows them to handle big clientage. The system makes it easier and faster to file the return. With user-friendly interface and multi-user functionality, the software lets you review 20,000 errors in one go and has 27 intrinsic features to save your time. Such unique features of Proseries hosting makes it the first choice of every accounting professional.
                        </p>
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            Winscloud offers an extensive ProSeries hosting solution to help individual and businesses. With our 365 days secured and updated servers, we assure you about the consistency and integrity of your confidential data. Our server also supports some of the best Proseries Add-ons including clients manager, network solutions, forms library and doc management system. With our cost-effective solutions, entrepreneurs are recommending our services to the others and that makes us a leading cloud hosting company.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="w-full py-12 bg-gray-100">
        <div class="w-full flex flex-col gap-4 items-center justify-center py-4 text-center">
            <h1 class="text-black font-semibold lg:text-[35px] md:text-[35px] text-[30x]">Benefits of WinsCloud ProSeries Hosting</h1>
            ...
            <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-center lg:w-[600px] md:w-[600px] sm:w-full">
                Proseries hosting: Simplify finances, access anywhere, anytime, for peace of mind
            </p>
        </div>
            ...
            <div class="  w-full grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 ">
                ...
                <div class="w-full flex gap-2 group bg-white rounded-md p-8 items-center relative featureBoxesDiv">
                    ...
                    <div class="flex flex-col gap-2 w-full z-20 items-center justify-center">
                        ...
                        <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-left w-full group-hover:text-white transition ease-in duration-2000">
                            We have the best prices that reduce enormous investments building an infrastructure. Here you are free to select the resources as per your organisation's need and then pay for services that you have used.
                        </p>
                ...
                <div class="w-full flex gap-2 group bg-white rounded-md p-8 items-center relative featureBoxesDiv">
                    ...
                    <div class="flex flex-col gap-2 w-full z-20 items-center justify-center">
                        ...
                        <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-left w-full group-hover:text-white transition ease-in duration-2000">
                            WinsCloud hosted Proseries uses end-to-end encryption to provide the maximum level of security access to every user.
                        </p>
                ...
                <div class="w-full flex gap-2 group bg-white rounded-md p-8 items-center relative featureBoxesDiv">
                    ...
                    <div class="flex flex-col gap-2 w-full z-20 items-center justify-center">
                        ...
                        <h1 class="text-black font-semibold lg:text-[22px] md:text-[22px] text-[17px] mt-4 group-hover:text-white transition ease-in duration-2000">
                            Centralization of Workforce
                        </h1>
                        <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-left w-full group-hover:text-white transition ease-in duration-2000">
                            You can allow all of your employees to access the same server to avoid any delay in work.
                        </p>
