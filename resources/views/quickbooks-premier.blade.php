...
@section('content')
        ...
        <div class="lg:w-[70%] md:w-[90%] w-full h-full mx-auto">
            <div class="w-full flex flex-col items-center gap-4 justify-center py-4 text-center">
                <h1 class="text-black font-semibold lg:text-[30px] md:text-[30px] text-[25px]">
                    Premier QuickBooks Hosting: Hassle-Free Accounting Solution
                </h1>
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/quickbooks-hosting/qb-premier.jpg')}}" alt="">
                    </div>
                ...
                <div class="w-full h-full flex">
                    <div class=" text-justify p-4">
                        ...
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            Winscloud QuickBooks premier hosting will empower CA, accountants and financial advisors with the best tool to organise all economic data in one place. Hosted by our servers, the online QuickBooks application has revolutionised every industry with its fast, efficient and reliable accounting platforms. The systems are highly beneficial for small businessmen, non-profit organisations manufacturing units, and retailers. A significant benefit of our premier QuickBooks hosting is its industry-specific tools, which will help you to use the application to its fullest.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="w-full py-12 bg-gray-100">
        <div class="w-full flex flex-col gap-4 items-center justify-center py-4 text-center">
            <h1 class="text-black font-semibold lg:text-[35px] md:text-[35px] text-[30x]">Features of Winscloud Quickbooks Premier Hosting</h1>
            ...
            <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-center lg:w-[600px] md:w-[600px] sm:w-full">
                QuickBooks Premier hosting: Simplify finances, access anywhere, anytime, for peace of mind
            </p>
        </div>
            ...
            <div class="  w-full grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 ">
                ...
                <div class="w-full flex gap-2 group bg-white rounded-md p-8 items-center relative featureBoxesDiv">
                    ...
                    <div class="flex flex-col gap-2 w-full z-20 items-center justify-center">
                        ...
                        <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-left w-full group-hover:text-white transition ease-in duration-2000">
                            Provide Remote access functionality As QuickBooks applications work on the cloud hosting, users are free to access the files from anywhere at any time.
                        </p>
                ...
                <div class="w-full flex gap-2 group bg-white rounded-md p-8 items-center relative featureBoxesDiv">
                    ...
                    <div class="flex flex-col gap-2 w-full z-20 items-center justify-center">
                        ...
                        <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-left w-full group-hover:text-white transition ease-in duration-2000">
                            Multi-user access QuickBooks multiple user access simultaneously with no lag or crash.
                        </p>
                ...
                <div class="w-full flex gap-2 group bg-white rounded-md p-8 items-center relative featureBoxesDiv">
                    ...
                    <div class="flex flex-col gap-2 w-full z-20 items-center justify-center">
                        ...
                        <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-left w-full group-hover:text-white transition ease-in duration-2000">
                            E-banking and reconciliation With the help of automated platforms, you can match your bank's transaction with those you have recorded in your QuickBooks.
                        </p>
                ...
                <div class="w-full flex gap-2 group bg-white rounded-md p-8 items-center relative featureBoxesDiv">
                    ...
                    <div class="flex flex-col gap-2 w-full z-20 items-center justify-center">
                        ...
                        <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-left w-full group-hover:text-white transition ease-in duration-2000">
                            Enjoy the convenience of accessing your QuickBooks Premier Hosting data from anywhere, at any time, for seamless financial management
                        </p>
        ...
        <div class="lg:w-[70%] md:w-[90%] w-full h-full mx-auto">
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                <div class="w-full h-full flex justify-end">
                    <div class=" text-justify p-4">
                        <h1 class="text-black font-semibold lg:text-[30px] md:text-[30px] text-[25px]">
                            We Do Understand your QuickBooks Hosting Requirements
                        </h1>
                        ...
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            Our excellent QuickBooks hosting solution is designed as per the industry standards and gives you complete access to your files across the globe at any instant of time. Whether you are at home, travelling or on vacation, you can access the essential data anytime from anywhere. Intuit QuickBooks Cloud hosting offers user-friendly functionality with undisputed security. You don't need to worry about the system failure or data corruption if your financial data get hosted with us. Our organisation gets completed by our skilled and dedicated management and technical team which are carrying an immense level of experience. With the in-depth knowledge of cloud computing, our dedicated team the breaks its sweat to bring your QuickBooks alive over the web and as a desktop app with utter professionalism.
                        </p>
                    </div>
                </div>
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/quickbooks-hosting/invoicing-shape3.png')}}" alt="">
                    </div>
                    <img class="rotatingImg w-auto lg:h-[600px] md:h-[600px] h-[500px] mx-auto" src="{{asset('assets/images/home/circle.png')}}" alt="">
                </div>
            ...
            <div class="w-full flex flex-col items-center gap-4 justify-center py-4 text-center">
                <h1 class="text-black font-semibold lg:text-[30px] md:text-[30px] text-[25px]">
                    Why Should You Choose Winscloud Premier QuickBooks Hosting?
                </h1>
                <div class="lg:hidden md:hidden block h-[5px] w-[100px] bg-[#cdf1d8] rounded-md relative">
                    <div class="bg-[#44ce6f] h-[12px] w-[12px] rounded-full absolute -top-1 movingDiv ">
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                        ...
                        <div class="grid grid-cols-2 gap-6 mt-6">
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    ...
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Industry-specific reports With QuickBooks premier hosting you are free to business specific reports such as customer edition reports, non-profits edition reports, etc.</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Manage customers particular services You can easily track services by customer types with the help of customer edition reports in premier QuickBooks Hosting.</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Tracks sales You can monitor your overall sales and order through various sales and order reports.</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Inventory customisation The inventory reports of QuickBooks will allow getting a deep insight into the products you have.</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Due payment invoices With the help of the Employees and Payroll report, you can check the due payment invoices of your organisation and employees</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Opt for Winscloud Premier QuickBooks Hosting to streamline your financial management. Benefit from seamless accessibility, security, and expert support</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                ...
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/quickbooks-hosting/qb-premier-mob.png')}}" alt="">
                    </div>
                    <img class="rotatingImg w-auto lg:h-[600px] md:h-[600px] h-[500px] mx-auto" src="{{asset('assets/images/home/circle.png')}}" alt="">
                </div>
            </div>
