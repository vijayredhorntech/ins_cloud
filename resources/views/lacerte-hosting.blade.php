...
@section('content')
        ...
        <div class="lg:w-[70%] md:w-[90%] w-full h-full mx-auto">
            <div class="w-full flex flex-col items-center gap-4 justify-center py-4 text-center">
                <h1 class="text-black font-semibold lg:text-[30px] md:text-[30px] text-[25px]">
                    Lacerte Hosting: Simplify Tax Workflow with Secure, Cloud-Based Solutions
                </h1>
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/services/lacerte-hosting.jpg')}}" alt="">
                    </div>
                ...
                <div class="w-full h-full flex">
                    <div class=" text-justify p-4">
                        ...
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            Lacerte Tax software emerged as one of the most advanced taxes and accounting utility for both individual and business clients. The LacerteHosting platform offers the complete solutions for collecting the data, tax filling, consulting, research and practices. Our clients can also use its end-to-end system functionality which reduces the time involved in massive tax preparations. The LacerteHosting software provides more than 5700 forms and 32 packaged features that save your time and money. The forms cover all the details from the simplest one to most complicated one, and that includes publicly traded partnerships, investment interest expense deduction, and debt forgiveness, and instalment sale of the business.
                        </p>
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            WinsCloudMatrix offers the user to experience the power of Lacerte Cloud Hosting and manage your clientage by giving them time and money saving services of high standards. With our state of the art Lacerte Hosting features and fastest technical support, we are facilitating a vast number of organizations and individual accountants.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="w-full py-12 bg-gray-100">
        <div class="w-full flex flex-col gap-4 items-center justify-center py-4 text-center">
            <h1 class="text-black font-semibold lg:text-[35px] md:text-[35px] text-[30x]">Benefits of Lacerte Hosting Services by Winscloud</h1>
            ...
            <p class="text-gray-400 text-[16px] font-[400] mt-2 leading-8 text-center lg:w-[600px] md:w-[600px] sm:w-full">
                Lacerte hosting: Simplify finances, access anywhere, anytime, for peace of mind
            </p>
        </div>
