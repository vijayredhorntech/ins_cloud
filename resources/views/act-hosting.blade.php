...
@section('content')
        ...
        <div class="lg:w-[70%] md:w-[90%] w-full h-full mx-auto">
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/services/act-soft.jpg')}}" alt="">
                    </div>
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                        ...
                        <div class="grid grid-cols-2 gap-6 mt-6">
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    ...
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Opportunity Management</span>
                                </div>
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Deployment, Access</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Payment Flexibilit</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Administration and Security & Sales and Opportunity Tracking</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Integration and Automation & Contact and Activity Management</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                            ...
                            <div class="w-full flex gap-2 group bg-white rounded-md p-3 relative featureBoxesDiv shadow-lg shadow-gray-200">
                                <div class="flex gap-2 w-full z-20 ">
                                    <i class="fa-solid fa-check text-[#ee0979] group-hover:text-white"></i>
                                    <span class="font-semibold  text-[15px] text-gray-500 group-hover:text-white transition ease-in duration-2000">Email Marketing & Mobility</span>
                                </div>
                                <div  class=" featureBoxes absolute top-0  left-0 h-full w-0 rounded-md bg-gradient-to-r from-[#ee0979] to-[#ff6a00]">
                ...
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/services/act-hosting.jpg')}}" alt="">
                    </div>
                    <img class="rotatingImg w-auto lg:h-[600px] md:h-[600px] h-[500px] mx-auto" src="{{asset('assets/images/home/circle.png')}}" alt="">
                </div>
            </div>
    ...
    <div class="w-full py-12 bg-gray-100">
        <div class="w-full flex flex-col gap-4 items-center justify-center py-4 text-center">
            <h1 class="text-black font-semibold lg:text-[35px] md:text-[35px] text-[30x]">Why Choose WinsCloud ACT Hosting</h1>
