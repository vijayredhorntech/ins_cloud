        ...
        <div class="lg:w-[70%] md:w-[90%] w-full h-full mx-auto">
            <div class="w-full flex flex-col items-center gap-4 justify-center py-4 text-center">
                <h1 class="text-black font-semibold lg:text-[30px] md:text-[30px] text-[25px]">
                    Unlocking the Power of Cloud Server Hosting: A Comprehensive Guide to Scalable and Reliable Solutions.
                </h1>
                ...
                <div class="w-full h-full flex">
                    <div class=" text-justify p-4">
                        ...
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            Winscloud provides some of the best cloud hosting solutions on the market. With their cutting-edge technology and innovative features, we can offer customers a reliable and efficient service. Wins offer a comprehensive suite of cloud hosting solutions that are designed to meet the unique needs of businesses of all sizes. From small businesses to enterprise organizations, we have a solution that is right for you.
                        </p>
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 ">
                <div class="w-full h-full flex justify-end">
                    <div class=" text-justify p-4">
                        ...
                        <p class="text-gray-500 text-[16px] font-[400] mt-8 leading-8">
                            At Winscloud, we pride ourselves on being the best cloud server provider in the business. We are always looking for new ways to improve our service and make our customers' lives easier. To provide flexible and scalable Cloud Hosting solutions we are constantly innovating and expanding services so that our customers can always rely on us.Winscloud’s Cloud server providers are a reliable and trusted name when it comes to providing cloud hosting services. We have a team of experts who are always available to take care of all the technical issues that may arise. The company has a wide range of services that it offers, from maintaining infrastructure to managing the software hassle. This makes Winscloud’s flexible and scalable Cloud Hosting the perfect partner for any business that wants to move to the cloud.
                        </p>
                    </div>
                </div>
                <div class="w-full h-max p-4 relative">
                    ...
                    <div class="absolute top-0 left-0 py-12 px-2 w-full h-full z-20">
                        <img class=" w-full h-full object-cover" src="{{asset('assets/images/services/invoicing-shape1.png')}}" alt="">
                    </div>
                    <img class="rotatingImg w-auto lg:h-[600px] md:h-[600px] h-[500px] mx-auto" src="{{asset('assets/images/home/circle.png')}}" alt="">
                </div>
