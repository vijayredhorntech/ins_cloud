                ...
                <div class="w-full flex flex-col gap-2">
                    <div class="grid  grid-cols-1 gap-6">
                        <div class="flex items-center w-full gap-6">
                            <label for="name" class="text-gray-500 font-normal text-[18px] w-32"> UserName:</label>
                            <input type="text" placeholder="Enter your name here" class="p-3 w-full ">

                        </div>

                        <div class="flex items-center w-full gap-6">
                            <label for="name" class="text-gray-500 font-normal text-[18px] w-32">Email:</label>
                            <input type="email" placeholder="Enter your email here" class="p-3 w-full ">

                        </div>

                        <div class="flex items-center w-full gap-6">
                            <label for="name" class="text-gray-500 font-normal text-[18px] w-32">Comment:</label>
                            <textarea type="email" placeholder="Enter your comment here" class="p-3 w-full " rows="5"></textarea>

                        </div>

                        <div class="flex items-center w-full gap-6">
                            <label for="name" class="text-gray-500 font-normal text-[18px] w-32">Chose File:</label>
                            <div class="w-full bg-white flex gap-2 ">
                                <div class="bg-gray-50 overflow-hidden flex relative py-3">
                                     <span>Chose File</span>
                                    <input type="file" placeholder="Enter your email here" class="p-3 w-full absolute top-0 left-0 opacity-0 ">
                                </div>
